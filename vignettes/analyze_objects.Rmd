...
fig_caption: yes
vignette: >
  %\VignetteIndexEntry{Analyzing objects in an image}
...
```{r}
library(pliman)
img <- image_import(image_pliman("objects_300dpi.jpg"), plot = TRUE)
```
